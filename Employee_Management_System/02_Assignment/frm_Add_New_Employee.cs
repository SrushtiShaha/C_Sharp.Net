...
namespace Employee_Management_System
{
    public partial class frm_Add_New_Employee : Form
    {
        ...
        void Auto_Incr()
        {
            ...
            Cmd.Connection = Con;
            Cmd.CommandText = "Select Count(*) from Employee_List";
            ...
            {
                Cmd.Connection = Con;
                Cmd.CommandText = "Select Max(Emp_Id) from Employee_List";
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            if (tb_Id.Text != "" && tb_Name.Text != "" && tb_MobNo.Text != "" && cmb_Des.Text != "")
            {
                ...
                cmd.Connection = Con;
                cmd.CommandText = "Insert Into Employee_List Values(@Id, @Nm, @MobNo, @DOB, @Des)";
